describe('iterator', function() {
  ...
  describe('use to provide accessor API ', function () {
    ...
    beforeEach(inject(function ($materialUtil) {
      list = [ 13, 14, 'Marcy', 15, 'Andrew', 16, 21, 'Adam', 37, 'Max', 99 ];
      iter = $materialUtil.iterator(list);
    }));

    it('should construct properly', inject(function($materialUtil) {
      expect(iter.count()).toEqual(11);

      var iter2 = $materialUtil.iterator();
  ...
  describe('use to provide navigation API ', function () {
    ...
    it('should last() items properly', inject(function ($materialUtil) {
      ...
      iter = $materialUtil.iterator([ 2, 5 ]);
      iter.remove(2);
    ...
    it('should use hasPrevious() properly', inject(function ($materialUtil) {
      ...
      iter =  $materialUtil.iterator(list = [ 2, 3 ]);
      expect( iter.hasPrevious(iter.last()) ).toBe(true);
      iter.remove(2);
