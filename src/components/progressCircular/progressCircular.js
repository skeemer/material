...
angular.module('material.components.progressCircular', [
  ...
  .directive('materialProgressCircular', [
    '$$rAF',
    '$materialEffects',
    MaterialProgressCircularDirective
  ]);

/**
 * @ngdoc directive
 * @name materialProgressCircular
 ...
 * @usage
 * <hljs lang="html">
 * <material-progress-circular mode="determinate" value="..."></material-progress-circular>
 *
 * <material-progress-circular mode="determinate" ng-value="..."></material-progress-circular>
 *
 * <material-progress-circular mode="determinate" value="..." diameter="100"></material-progress-circular>
 *
 * <material-progress-circular mode="indeterminate"></material-progress-circular>
 * </hljs>
 */
function MaterialProgressCircularDirective($$rAF, $materialEffects) {
